...
def test(rgb, colornet):
    ...
    lstm_state = None
    out_rgb, lstm_state = colornet(rgb, y_t_last, lstm_state)
...
def getImage(root):
    ...
    img = Image.open(root)
    img = img.resize((256, 256), Image.ANTIALIAS).convert('RGB')
...
if __name__ == "__main__":
    ...
    root = '/home/alien/Documents/zyz/VideoColor/AircraftLanding/00000.jpg'
    path = '/home/alien/Documents/zyz/vid2vidG/models/models_for_color/Pre_colorization_epoch2400_bs1.pth'
    colornet = torch.load(path).cuda()
